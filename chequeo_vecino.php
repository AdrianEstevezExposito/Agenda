...
<html>
		<table align="center" border=0  width="800" height="80">
			...
			<TR> 
			   <TD><center><img border="0" src="imagenes/gato.jpg" width="70" height="100"></b></center></TD> 
			   <TD><center><font size=3><b></b></h2></center></TD> 
			   <TD><center><img border="0" src="imagenes/rompetechos.jpg" width="100" height="100"></center></TD> 
			</TR> 
		</TABLE>
		<br><br>
	...
	<?php
        ...
        echo "<center> <FORM ACTION='buscar_vecino.php' METHOD='post'> <INPUT TYPE='submit' NAME='menu' VALUE='Volver al Buscador'> </center>	 </FORM><br>";
		echo "<table cellpadding='10' cellspacing='0' align='center' border=0>";
		echo "<td align='center' bgcolor='#999999'> <b>Nombre</b> </td>"."<td align='center' bgcolor='#999999'> <b>Primer Apellido</b> </td>"."<td align='center' bgcolor='#999999'> <b>Segundo Apellido</b> </td>"."<td align='center' bgcolor='#999999'> <b>Tel&eacute;fono</b> </td>"."<td align='center' bgcolor='#999999'> <b>Direcci&oacute;n</b> </td>"."<td align='center' bgcolor='#999999'> <b>Identificador de Vecino</b> </td>"."</tr></tr>";
